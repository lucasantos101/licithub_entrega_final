        ...
        <form action="{{ route('admins.update', $admin) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="user_type" name="user_type" required>
                    <option value="customer" {{ old('user_type', $admin->user_type) === 'customer' ? 'selected' : '' }}>Cliente</option>
                    <option value="admin" {{ old('user_type', $admin->user_type) === 'admin' ? 'selected' : '' }}>Administrador</option>
                </select>
            </div>
